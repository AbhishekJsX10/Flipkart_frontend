    ...
    <div className="w-full bg-gray-100 p-4">
      {products.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          ...
          <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex items-center p-4">
            <div>
              ...
              <button onClick={handelBuy} className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:to-yellow-400 border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3">
                Proceed to Buy
              </button>
            </div>
          </div>
        ...
        <motion.div
          ...
          className="flex justify-center items-center gap-4 py-10  flex-col md:flex-row"
        >
          <div className="w-[100%]">
            <img
          ...
          <div className="w-auto p-4 bg-white flex  flex-col items-center rounded-md shadow-lg">

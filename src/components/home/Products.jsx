//This page contains the details of the Products for Banner like product image, product title, product description, product price, product rating and AddToCart Button
      ...
      {productsData.map((item) => (
        ...
        >
          ...
          <Link to={`/product/${item.id}`}>
            ...
            <button
              onClick={() =>handelAddingToCart(item)}
